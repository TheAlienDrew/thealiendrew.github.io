    ...
    (function (AVM2) {
        ...
        (function (Runtime) {
            ...
            (function (ExecutionMode) {
                ExecutionMode[ExecutionMode["INTERPRET"] = 1] = "INTERPRET";
                ExecutionMode[ExecutionMode["COMPILE"] = 2] = "COMPILE";
            })(ExecutionMode = Runtime.ExecutionMode || (Runtime.ExecutionMode = {}));
...
(function (Shumway) {
    ...
    (function (AVMX) {
        ...
        })(Bytecode = AVMX.Bytecode || (AVMX.Bytecode = {}));
        ...
        (function (Flags) {
            ...
            Flags[Flags["CAN_THROW"] = 8] = "CAN_THROW";
            Flags[Flags["RETURN"] = 16] = "RETURN";
        })(Flags || (Flags = {}));
        /**
...
(function (Shumway) {
    ...
    (function (AVMX) {
        ...
        })(CONSTANT = AVMX.CONSTANT || (AVMX.CONSTANT = {}));
        ...
        var METHOD;
        (function (METHOD) {
            METHOD[METHOD["NeedArguments"] = 1] = "NeedArguments";
            ...
            METHOD[METHOD["HasBody"] = 256] = "HasBody";
            METHOD[METHOD["InstanceInitializer"] = 512] = "InstanceInitializer";
            METHOD[METHOD["ClassInitializer"] = 1024] = "ClassInitializer";
            METHOD[METHOD["ScriptInitializer"] = 2048] = "ScriptInitializer";
        })(METHOD = AVMX.METHOD || (AVMX.METHOD = {}));
        var TRAIT;
        (function (TRAIT) {
        ...
        })(NamespaceType = AVMX.NamespaceType || (AVMX.NamespaceType = {}));
        ...
        var Traits = /** @class */ (function () {
            ...
            Traits.prototype.resolveRuntimeTraits = function (superTraits, protectedNs, scope) {
                ...
                for (var i = 0; i < this.traits.length; i++) {
                    ...
                    var runtimeTrait = new RuntimeTraitInfo(name_1, trait.kind, trait.abc);
                    if (name_1.namespaces[0].type === 1 /* Protected */) {
                        // Names for protected traits get canonicalized to the name of the type that initially
                        // introduces the trait.
                        if (result.protectedNsMappings[name_1.name]) {
                            runtimeTrait.name = result.protectedNsMappings[name_1.name].name;
                        }
                        result.protectedNsMappings[name_1.name] = runtimeTrait;
                    }
        ...
        var SlotTraitInfo = /** @class */ (function (_super) {
            ...
            function SlotTraitInfo(abc, kind, name, slot, typeName, defaultValueKind, defaultValueIndex) {
                var _this = _super.call(this, abc, kind, name) || this;
                _this.slot = slot;
        ...
        var MethodTraitInfo = /** @class */ (function (_super) {
        ...
        var ClassTraitInfo = /** @class */ (function (_super) {
            __extends(ClassTraitInfo, _super);
            function ClassTraitInfo(abc, kind, name, slot, classInfo) {
                var _this = _super.call(this, abc, kind, name, slot, 0, 0, -1) || this;
        ...
        var InstanceInfo = /** @class */ (function (_super) {
            ...
            function InstanceInfo(abc, name, superName, flags, protectedNs, interfaceNameIndices, initializer, traits) {
                ...
                _this.interfaceNameIndices = interfaceNameIndices;
        ...
        var ABCFile = /** @class */ (function () {
            ...
            ABCFile.prototype.getMetadataInfo = function (i) {
                ...
                if (mi === undefined) {
                    ...
                    mi = this._metadata[i] = new MetadataInfo(this, name_3, keys, values);
                }
                return mi;
            };
...
(function (Shumway) {
    ...
    (function (AVMX) {
        ...
        function popNameInto(stack, mn, rn) {
            ...
            rn.kind = mn.kind;
            if (mn.isRuntimeName()) {
                var name_4 = stack.pop();
                // Unwrap content script-created AXQName instances.
                if (name_4 && name_4.axClass && name_4.axClass === name_4.sec.AXQName) {
                    name_4 = name_4.name;
                    release || assert(name_4 instanceof AVMX.Multiname);
                    rn.kind = mn.isAttribute() ? 18 /* RTQNameLA */ : 17 /* RTQNameL */;
                    rn.id = name_4.id;
                    rn.name = name_4.name;
                    rn.namespaces = name_4.namespaces;
                    return;
                }
                rn.name = name_4;
                rn.id = -1;
            ...
            interpretLabel: while (true) {
                ...
                try {
                    ...
                    switch (bc) {
                        ...
                        case 180 /* IN */:
                            receiver = sec.box(stack.pop());
                            var name_5 = stack[stack.length - 1];
                            if (name_5 && name_5.axClass === sec.AXQName) {
                                stack[stack.length - 1] = receiver.axHasProperty(name_5.name);
                            }
                            else {
                                stack[stack.length - 1] = receiver.axHasPublicProperty(name_5);
                            }
                            break;
        ...
        function createValidException(sec, internalError, bc, value, receiver, a, b, mn, expectedScopeStacksHeight) {
            ...
            switch (bc) {
                ...
                default:
                    ...
                    var stack_1 = internalError.stack.split('\n');
                    var lastFunctionEntry = stack_1[0].indexOf('at ') === 0 ? stack_1[0].substr(3) : stack_1[0];
    ...
    (function (AVMX) {
        ...
        function validateConstruct(sec, axClass, argc) {
            if (!axClass || !axClass.axConstruct) {
                var name_6 = axClass && axClass.classInfo ?
                    axClass.classInfo.instanceInfo.getName().name :
                    'value';
                sec.throwError('TypeError', AVMX.Errors.ConstructOfNonFunctionError, name_6);
            }
        ...
        })(WriterFlags = AVMX.WriterFlags || (AVMX.WriterFlags = {}));
        ...
        })(ScriptInfoState = AVMX.ScriptInfoState || (AVMX.ScriptInfoState = {}));
        var assert = Shumway.Debug.assert;
        ...
        var Scope = /** @class */ (function () {
            ...
            Scope.prototype.findScopeProperty = function (mn, strict, scopeOnly) {
                ...
                if (this.parent) {
                    var object_1 = this.parent.findScopeProperty(mn, strict, scopeOnly);
                    if (mn.kind === 7 /* QName */) {
                        this.cache[mn.id] = object_1;
                    }
                    return object_1;
                }
                if (scopeOnly) {
        ...
        var HasNext2Info = /** @class */ (function () {
         ...
         * }
             ...
             * don't rely on it.
             */
            HasNext2Info.prototype.next = function (obj, index) {
                ...
                var nextIndex = obj.axNextNameIndex(this.index);
                if (nextIndex > 0) {
         ...
         */
        var AXSecurityDomain = /** @class */ (function () {
        ...
        var AXApplicationDomain = /** @class */ (function () {
            ...
            AXApplicationDomain.prototype.findDefiningScript = function (mn, execute) {
                ...
                for (var i = 0; i < this._abcs.length; i++) {
                    var abc_1 = this._abcs[i];
                    script = this._findDefiningScriptInABC(abc_1, mn, execute);
                    if (script) {
                        return script;
                    }
                }
...
(function (Shumway) {
    ...
    (function (AVM2) {
        ...
        (function (AS) {
            ...
            var ASNative = /** @class */ (function (_super) {
        ...
        (function (AS) {
            ...
            var ASObject = /** @class */ (function () {
                ...
                ASObject.prototype.axSetProperty = function (mn, value, bc) {
                    ...
                    var mangledName;
                    if (t) {
                        mangledName = t.name.getMangledName();
                        switch (t.kind) {
                            case 1 /* Method */:
                ...
                ASObject.prototype.axGetEnumerableKeys = function () {
                    ...
                    for (var i = 0; i < keys.length; i++) {
                        ...
                        if (Shumway.isNumeric(key)) {
                            ...
                            var name_8 = Multiname.stripPublicMangledName(key);
                            if (name_8 !== undefined) {
                                result.push(name_8);
                            }
                        }
            ...
            var ASArray = /** @class */ (function (_super) {
                ...
                ASArray.prototype.native_propertyIsEnumerable = function (nm) {
                    ...
                    return _super.prototype.native_propertyIsEnumerable.call(this, nm);
                };
            ...
            var ASNumber = /** @class */ (function (_super) {
            ...
            AS.ASUint = ASUint;
            var ASMath = /** @class */ (function (_super) {
            ...
            var ASRegExp = /** @class */ (function (_super) {
                ...
                function ASRegExp(pattern, flags) {
                    ...
                    if (pattern === undefined) {
                        ...
                        if (flags) {
                            _this.sec.throwError("TypeError", AVMX.Errors.RegExpFlagsArgumentError);
                        }
                    ...
                    try {
                        ...
                        _this.value = new RegExp(ASRegExp.UNMATCHABLE_PATTERN, flags);
                    }
                                    ...
                                    switch (pattern[i + 2]) {
                                        ...
                                        default:
                                            if (/\(\?P<([\w$]+)>/.exec(pattern.substr(i))) {
                                                var name_9 = RegExp.$1;
                                                if (name_9 !== 'length') {
                                                    captureNames.push(name_9);
                                                }
                                                if (captureNames.indexOf(name_9) > -1) {
                ...
                ASRegExp.prototype.exec = function (str) {
                    ...
                    if (captureNames) {
                        for (var i = 0; i < captureNames.length; i++) {
                            var name_10 = captureNames[i];
                            if (name_10 !== null) {
                                // In AS3, non-matched named capturing groups return an empty string.
                                var value = result[i + 1] || '';
                                result[name_10] = value;
                                axResult.axSetPublicProperty(name_10, value);
                            }
                        }
                        return axResult;
                    }
            ...
            function linkSymbols(symbols, traits, obj) {
                for (var i = 0; i < traits.traits.length; i++) {
                    ...
                    var name_11 = trait.getName().name;
                    var qn = trait.getName().getMangledName();
                    if (trait.isSlot()) {
                        Object.defineProperty(obj, name_11, {
        ...
        (function (AS) {
            ...
            var Int32Vector = /** @class */ (function (_super) {
                ...
                function Int32Vector(length, fixed) {
                    ...
                    length = length >>> 0;
                    _this._fixed = !!fixed;
                    _this._buffer = new Int32Array(Math.max(Int32Vector.INITIAL_CAPACITY, length + Int32Vector.EXTRA_CAPACITY));
                    _this._offset = 0;
        ...
        (function (AS) {
            ...
            var Float64Vector = /** @class */ (function (_super) {
                ...
                function Float64Vector(length, fixed) {
                    ...
                    length = length >>> 0;
                    _this._fixed = !!fixed;
                    _this._buffer = new Float64Array(Math.max(Float64Vector.INITIAL_CAPACITY, length + Float64Vector.EXTRA_CAPACITY));
                    _this._offset = 0;
                    _this._length = length;
                    return _this;
                }
...
(function (Shumway) {
    ...
    (function (AVMX) {
        var AS;
        (function (AS) {
            AS.registerNativeClass("__AS3__.vec.Vector$object", AS.GenericVector, 'ObjectVector', 2 /* PackageInternal */);
            AS.registerNativeClass("__AS3__.vec.Vector$int", AS.Int32Vector, 'Int32Vector', 2 /* PackageInternal */);
            AS.registerNativeClass("__AS3__.vec.Vector$uint", AS.Uint32Vector, 'Uint32Vector', 2 /* PackageInternal */);
            AS.registerNativeClass("__AS3__.vec.Vector$double", AS.Float64Vector, 'Float64Vector', 2 /* PackageInternal */);
        })(AS = AVMX.AS || (AVMX.AS = {}));
    })(AVMX = Shumway.AVMX || (Shumway.AVMX = {}));
})(Shumway || (Shumway = {}));
/* tslint:disable */
    ...
    (function (AVMX) {
        ...
        (function (AS) {
            ...
            function toXML(v, sec) {
                ...
                var x = sec.xmlParser.parseFromString(AVMX.axCoerceString(v).trim());
            ...
            })(XMLParserErrorCode = AS.XMLParserErrorCode || (AS.XMLParserErrorCode = {}));
            ...
            var ASNamespace = /** @class */ (function (_super) {
                ...
                function ASNamespace(uriOrPrefix_, uri_) {
                    ...
                    if (arguments.length === 0) {
                        ...
                        // null
                        if (Shumway.isObject(uriValue) && uriValue.axClass === _this.sec.AXQName &&
                            uriValue.uri !== null) {
                            // i. Let n.uri = uriValue.uri
                            uri = uriValue.uri;
                        }
                        ...
                        if (uri === "") {
                            ...
                            if (prefixValue === undefined || toString(prefixValue, _this.sec) === "") {
                                ...
                                _this.sec.throwError('TypeError', AVMX.Errors.XMLNamespaceWithPrefixAndNoURI, prefixValue);
                            }
                        }
                    ...
                    // 5. Return n
                    _this._ns = AVMX.internPrefixedNamespace(0 /* Public */, uri, prefix);
                    return _this;
                }
            ...
            var ASQName = /** @class */ (function (_super) {
                ...
                function ASQName(nameOrNS_, name_) {
                    ...
                    // 8. Return q
                    _this.name = new AVMX.Multiname(null, 0, 7 /* QName */, [ns], localName);
                    return _this;
                }
            ...
            })(ASXMLKind = AS.ASXMLKind || (AS.ASXMLKind = {}));
            ...
            var ASXML = /** @class */ (function (_super) {
                ...
                function ASXML(value) {
                    ...
                    var x = toXML(value, _this.sec);
                    if (isXMLType(value, _this.sec)) {
                        x = x._deepCopy();
                    }
                    _this._kind = x._kind;
                    _this._name = x._name;
                    _this._value = x._value;
                    _this._attributes = x._attributes;
                    _this._inScopeNamespaces = x._inScopeNamespaces;
                    var children = x._children;
                ...
                ASXML.prototype.toXMLStringImpl = function (ancestorNamespaces, indentLevel) {
                    ...
                    for (var i = 0; i < namespaceDeclarations.length; i++) {
                        var namespace_1 = namespaceDeclarations[i];
                        if (namespace_1.uri === '') {
                            continue;
                        }
                        var attributeName = namespace_1.prefix ? 'xmlns:' + namespace_1.prefix : 'xmlns';
                        s += ' ' + attributeName + '="' + escapeAttributeValue(namespace_1.uri) + '"';
                    }
                    node._attributes && node._attributes.forEach(function (attr) {
                        var name = attr._name;
                ...
                ASXML.prototype.addInScopeNamespace = function (ns) {
                    ...
                    if (prefix !== undefined) {
                        ...
                        if (match_1 !== null && match_1.uri !== ns.uri) {
                            this._inScopeNamespaces.forEach(function (v, i) {
                                if (v.prefix === match_1.prefix) {
            ...
            var ASXMLList = /** @class */ (function (_super) {
                ...
                function ASXMLList(value) {
                    ...
                    if (value && value.axClass === _this.sec.AXXMLList) {
                        var children = value._children;
                        for (var i = 0; i < children.length; i++) {
                            var child = children[i];
                            _this._children[i] = child;
                            assert(_this._children[0]);
                        }
                    }
                    else {
                        toXMLList(value, _this);
                    }
                    return _this;
                }
                    ...
                    for (var i = 0; i < children.length; i++) {
                        ...
                        if (v._kind === 1 /* Element */) {
                            ...
                            if (isAttribute) {
                                ...
                                for (var j = 0; attributes && j < attributes.length; j++) {
                                    var v_1 = attributes[j];
                                    if ((isAnyName || v_1._name.name === nm) &&
                                        (isAnyNamespace || v_1._name.matches(mn))) {
                                        xl._children.push(v_1);
                                    }
                                }
                            }
                            else {
                                ...
                                for (var j = 0; descendants && j < descendants.length; j++) {
                                    var v_2 = descendants[j];
                                    if ((isAnyName || v_2._kind === 1 /* Element */ && v_2._name.name === nm) &&
                                        (isAnyNamespace || v_2._name.matches(mn))) {
                                        xl._children.push(v_2);
                                    }
                                }
                            }
                        }
                ...
                ASXMLList.prototype.setProperty = function (mn, value) {
                    ...
                    if (Shumway.isIndex(mn.name)) {
                        ...
                        // Step 2.c.
                        var length_2 = this._children.length;
                        if (i >= length_2) {
                            // Step 2.c.i.
                        ...
                        var parent_1 = currentChild._parent;
                        // Step 2.e.
                        if (childKind === 2 /* Attribute */) {
                            var indexInParent = parent_1._children.indexOf(currentChild);
                            parent_1.setProperty(currentChild._name, false);
                            this._children[i] = parent_1._children[indexInParent];
                        ...
                        if (value && value.axClass === this.sec.AXXMLList) {
                            ...
                            if (parent_1 !== null) {
                                // Step 2.f.iii.1.
                                var q = parent_1._children.indexOf(currentChild);
                                // Step 2.f.iii.2.
                                parent_1._replaceByIndex(q, c);
                                // Step 2.f.iii.3.
                                for (var j = 0; j < cLength; j++) {
                                    c._children[j] = parent_1._children[q + j];
                                }
                            }
                            // Step 2.f.iv.
                            if (cLength === 0) {
                                for (var j = i + 1; j < length_2; j++) {
                        ...
                        if (childKind >= 3 /* Text */ || value && value.axClass === this.sec.AXXML) {
                            ...
                            if (parent_1 !== null) {
                                ...
                                var q = parent_1._children.indexOf(currentChild);
                                // Step 2.g.ii.2.
                                parent_1._replaceByIndex(q, value);
                                // Step 2.g.ii.3.
                                value = parent_1._children[q];
                            }
                            // Step 2.g.iii.
    ...
    (function (AVMX) {
        ...
        (function (AS) {
            ...
            (function (DescribeTypeFlags) {
                DescribeTypeFlags[DescribeTypeFlags["HIDE_NSURI_METHODS"] = 1] = "HIDE_NSURI_METHODS";
                DescribeTypeFlags[DescribeTypeFlags["INCLUDE_BASES"] = 2] = "INCLUDE_BASES";
                DescribeTypeFlags[DescribeTypeFlags["INCLUDE_INTERFACES"] = 4] = "INCLUDE_INTERFACES";
                DescribeTypeFlags[DescribeTypeFlags["INCLUDE_VARIABLES"] = 8] = "INCLUDE_VARIABLES";
                DescribeTypeFlags[DescribeTypeFlags["INCLUDE_ACCESSORS"] = 16] = "INCLUDE_ACCESSORS";
                DescribeTypeFlags[DescribeTypeFlags["INCLUDE_METHODS"] = 32] = "INCLUDE_METHODS";
                DescribeTypeFlags[DescribeTypeFlags["INCLUDE_METADATA"] = 64] = "INCLUDE_METADATA";
                DescribeTypeFlags[DescribeTypeFlags["INCLUDE_CONSTRUCTOR"] = 128] = "INCLUDE_CONSTRUCTOR";
                DescribeTypeFlags[DescribeTypeFlags["INCLUDE_TRAITS"] = 256] = "INCLUDE_TRAITS";
                DescribeTypeFlags[DescribeTypeFlags["USE_ITRAITS"] = 512] = "USE_ITRAITS";
                DescribeTypeFlags[DescribeTypeFlags["HIDE_OBJECT"] = 1024] = "HIDE_OBJECT";
            ...
            function addTraits(cls, info, describingClass, flags) {
                ...
                if (flags & 4 /* INCLUDE_INTERFACES */) {
                    ...
                    if (!describingClass) {
                        var interfacesVal_1 = obj.$Bginterfaces.value;
                        var interfaces = cls.classInfo.instanceInfo.getInterfaces(cls);
                        interfaces.forEach(function (iface) { return interfacesVal_1.push(iface.name.toFQNString(true)); });
                    }
                }
                else {
                ...
                function describeTraits(sec, traits, isInterface) {
                    ...
                    for (var i = 0; i < traits.length; i++) {
                        ...
                        var name_12 = isInterface ? mn.name : mn.toFQNString(true);
                        if (encounteredGetters[name_12] !== encounteredSetters[name_12]) {
                            var val_1 = encounteredKeys[name_12];
                            val_1.$Bgaccess = 'readwrite';
                            if (t.kind === 2 /* Getter */) {
                                var type = t.getMethodInfo().getType();
                                val_1.$Bgtype = type ? type.name.toFQNString(true) : '*';
                            }
                            continue;
                        }
                        if (encounteredKeys[name_12]) {
                            continue;
                        }
                        //TODO: check why we have public$$_init in `Object`
                        var val = sec.createObject();
                        encounteredKeys[name_12] = val;
                        ...
                        switch (t.kind) {
                            ...
                            case 3 /* Setter */:
                                ...
                                val.$Bgname = name_12;
                                if (t.kind === 2 /* Getter */) {
                                    var returnType_1 = t.getMethodInfo().getType();
                                    val.$Bgtype = returnType_1 ? returnType_1.name.toFQNString(true) : '*';
                                    encounteredGetters[name_12] = val;
                                }
                                else {
                                    var paramType = t.getMethodInfo().parameters[0].getType();
                                    val.$Bgtype = paramType ? paramType.toFQNString(true) : '*';
                                    encounteredSetters[name_12] = val;
                                }
                ...
                (function (utils) {
                    ...
                    var ASProxy = /** @class */ (function (_super) {
                        ...
                        ASProxy.prototype.axGetProperty = function (mn) {
                            ...
                            if (trait) {
                                var name_13 = trait.name.getMangledName();
                                value = this[name_13];
                                if (typeof value === 'function') {
                                    return this.axGetMethod(name_13);
                                }
                            }
                            else {
...
(function (Shumway) {
    ...
    (function (AVMX) {
        var AS;
        (function (AS) {
            var ASDate = /** @class */ (function (_super) {
                ...
                function ASDate(yearOrTimevalue, month, date, hour, minute, second, millisecond) {
                    ...
                    switch (arguments.length) {
                        case 0:
                            ...
                            break;
                        case 1:
                            _this.value = new Date(yearOrTimevalue);
                            break;
                        case 2:
                            _this.value = new Date(yearOrTimevalue, month);
                            break;
                        case 3:
                            _this.value = new Date(yearOrTimevalue, month, date);
                            break;
                        case 4:
                            _this.value = new Date(yearOrTimevalue, month, date, hour);
                            break;
                        case 5:
                            _this.value = new Date(yearOrTimevalue, month, date, hour, minute);
                            break;
                        case 6:
                            _this.value = new Date(yearOrTimevalue, month, date, hour, minute, second);
                            break;
                        default:
                            _this.value = new Date(yearOrTimevalue, month, date, hour, minute, second, millisecond);
                            break;
                    }
                    return _this;
                }
            ...
            (function (flash) {
                ...
                (function (system) {
                    var IME = /** @class */ (function (_super) {
                        ...
                        return IME;
                    }(AS.ASObject /* flash.events.EventDispatcher */));
                    system.IME = IME;
...
(function (Shumway) {
    ...
    (function (AVMX) {
        ...
        })(AMF0Marker = AVMX.AMF0Marker || (AVMX.AMF0Marker = {}));
            ...
            AMF0.read = function (ba) {
                ...
                switch (marker) {
                    ...
                    case 10 /* STRICT_ARRAY */:
                        array = ba.sec.createArray([]);
                        var length_3 = array.length = (ba.readByte() << 24) | (ba.readByte() << 16) |
                            (ba.readByte() << 8) | ba.readByte();
        ...
        })(AMF3Marker = AVMX.AMF3Marker || (AVMX.AMF3Marker = {}));
        function readU29(ba) {
            var b1 = ba.readByte();
            if ((b1 & 0x80) === 0) {
                return b1;
                ...
                case "object":
                    if (value === null) {
                        ...
                        AVMX.forEachPublicProperty(array, function (i, value) {
                            if (Shumway.isNumeric(i) && i >= 0 && i < densePortionLength_1) {
                                return;
                            }
