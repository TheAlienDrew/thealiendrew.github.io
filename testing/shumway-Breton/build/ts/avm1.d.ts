declare module Shumway.AVM1 {
    let avm1TraceEnabled: any;
    let avm1ErrorsEnabled: any;
    let avm1WarningsEnabled: any;
    let avm1TimeoutDisabled: any;
    let avm1CompilerEnabled: any;
    let avm1DebuggerEnabled: any;
    let avm1WellknownActionsCompilationsEnabled: any;
}
declare module Shumway.AVM1 {
...
declare module Shumway.AVM1 {
    ...
    let MAX_AVM1_HANG_TIMEOUT: number;
    let CHECK_AVM1_HANG_EVERY: number;
...
declare module Shumway.AVM1.Lib {
    ...
    class AVM1NativeActions {
        ...
        call(frame: any): void;
        chr(code: any): string;
        duplicateMovieClip(target: any, newname: any, depth: number): void;
        ...
        mbsubstring(value: any, index: number, count: number): string;
        nextFrame(): void;
        nextScene(): void;
        ...
        stopAllSounds(): void;
        stopDrag(): void;
        substring(value: any, index: number, count: number): string;
...
declare module Shumway.AVM1.Lib {
    ...
    class AVM1Key extends AVM1Object {
        ...
        static isDown(context: AVM1Context, code: number): boolean;
...
declare module Shumway.AVM1.Lib {
    ...
    class AVM1MovieClip extends AVM1SymbolBase<flash.display.MovieClip> {
        ...
        get$version(): string;
        attachMovie(symbolId: string, name: string, depth: number, initObject: any): AVM1MovieClip;
        ...
        createEmptyMovieClip(name: any, depth: number): AVM1MovieClip;
        createTextField(name: any, depth: number, x: number, y: number, width: number, height: number): AVM1TextField;
        get_currentframe(): number;
        curveTo(controlX: number, controlY: number, anchorX: number, anchorY: number): void;
        get_droptarget(): flash.display.DisplayObject;
        duplicateMovieClip(name: any, depth: number, initObject: any): AVM1MovieClip;
        getEnabled(): boolean;
...
declare module Shumway.AVM1.Lib {
    ...
    class AVM1Transform extends AVM1Object {
        ...
        private _target;
        private _targetAS3Object;
        readonly as3Transform: flash.geom.Transform;
        avm1Constructor(target_mc: any): void;
...
declare module Shumway.AVM1.Lib {
    ...
    class AVM1BitmapData extends AVM1Object implements IHasAS3ObjectReference {
        ...
        readonly as3BitmapData: flash.display.BitmapData;
