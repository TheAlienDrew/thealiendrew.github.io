...
declare module Shumway.AVM2 {
    module Runtime {
        let traceRuntime: any;
        let traceExecution: any;
        let traceInterpreter: any;
        let debuggerMode: any;
...
declare module Shumway.AVMX {
     ...
     */
    let BytecodeFlags: Uint32Array;
    let BytecodeFormat: any[];
    /**
    ...
    class BytecodeStream {
        ...
        next(): void;
        endBCI(): number;
        readonly nextBCI: number;
        readonly currentBCI: number;
...
declare module Shumway.AVMX {
    ...
    class ABCFile {
        ...
        readonly applicationDomain: AXApplicationDomain;
        private _stream;
        private _strings;
...
declare let $: Shumway.AVMX.AXSecurityDomain;
declare module Shumway.AVMX {
    ...
    let runtimeWriter: IndentingWriter;
    let executionWriter: IndentingWriter;
    let interpreterWriter: IndentingWriter;
    ...
    function axCompare(a: any, b: any, options: SORT, sortOrder: number, compareFunction: (a: any, b: any) => number): number;
     ...
     * }
         ...
         * don't rely on it.
         */
        next(obj: AXObject, index: number): void;
    }
    let scopeStacks: ScopeStack[];
    ...
    class AXSecurityDomain {
        ...
        readonly xmlParser: AS.XMLParser;
        private _xmlParser;
        ...
        readonly AXFunctionUndefinedPrototype: any;
         ...
         */
        createObjectFromJS(value: any, deep?: boolean): any;
        /**
 ...
 */
declare let as3Compatibility: boolean;
/**
...
declare module Shumway.AVMX.AS {
    ...
    module Natives {
        ...
        function bugzilla(_: AXSecurityDomain, n: number): boolean;
        ...
        let isNaN: (number: number) => boolean;
        let isFinite: (number: number) => boolean;
        let parseInt: (s: string, radix?: number) => number;
        let parseFloat: (string: string) => number;
        let escape: (x: any) => any;
        let unescape: (x: any) => any;
        let isXMLName: (x: any) => boolean;
        let notImplemented: (x: any) => void;
        /**
    ...
    function getNativesForTrait(trait: TraitInfo): any[];
...
declare module Shumway.AVMX.AS {
    class Int32Vector extends BaseVector {
        ...
        toLocaleString(): string;
        _view(): Int32Array;
        _ensureCapacity(length: number): void;
        concat(): Int32Vector;
        /**
         * Executes a |callback| function with three arguments: element, index, the vector itself as
         * well as passing the |thisObject| as |this| for each of the elements in the vector. If any of
...
declare module Shumway.AVMX.AS {
    ...
    class XMLParser extends XMLParserBase {
        ...
        parseFromString(s: string, mimeType?: any): ASXML;
    }
    ...
    class ASXML extends ASObject implements XMLType {
        ...
        _delete(key: string, isMethod: boolean): void;
...
declare module Shumway.AVMX.AS {
    module flash.system {
        ...
        class System extends ASObject {
            ...
            static classInitializer(): void;
            static readonly ime: flash.system.IME;
            static setClipboard(string: string): void;
            static readonly totalMemoryNumber: number;
            static readonly freeMemory: number;
            static readonly privateMemory: number;
            static useCodePage: boolean;
            static readonly vmVersion: string;
            static pause(): void;
            static resume(): void;
            ...
            static readonly swfVersion: number;
            static readonly apiVersion: number;
            static getArgv(): any[];
            static getRunmode(): string;
        }
        let OriginalSystem: typeof System;
    }
}
/**
